...
function Plans() {
  return (
    ...
    <div className="md:flex items-center justify-center flex-wrap md:w-[100%] ">
        <div className=" h-[70vh] md:w-[22%] text-center overflow-hidden hover:scale-105 duration-500 mx-14 my-5 shadow-xl border-2 border-gray-400 hover:border-orange-600 rounded-lg">
